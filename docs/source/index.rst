.. py_as_db documentation master file, created by
   sphinx-quickstart on Tue Sep 17 13:34:39 2024.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

py_as_db - Using Python files as a database
==============================================

Release v\ |version| (:doc:`/user/install`)

.. image:: https://img.shields.io/github/license/tathyagarg/py_as_db
    :alt: MIT Licensed

.. image:: https://img.shields.io/github/commit-activity/t/tathyagarg/py_as_db
    :target: https://github.com/tathyagarg/py_as_db
    :alt: Total GitHub commits to `py_as_db`

**py_as_db** is a Python library to make databases in the form of python files. Obviously, this is just a joke and serves little to no practical benefits over other databasing software. This won't stop me from making this project way over the top.
